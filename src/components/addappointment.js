          ...
          <div className='window '>
            ...
            <div className='content'>
              ...
              <Formik
                ...
                <input className="form-control" onChange={handleChange} value={values.startDate} name="startDate"placeholder="StartDate" />
                <input className="form-control" onChange={handleChange} value={values.endDate} name="endDate"placeholder="EndDate" />
